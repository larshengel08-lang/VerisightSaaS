...
| --- | --- | --- | --- |
| `HR buyer / HR director` | Action Center is an HR-governed follow-through layer inside Loep for route-bound post-scan execution, review rhythm, and closeout discipline. | workflow software, task board, standalone module, impact-proof engine | governance one-pager, route -> action -> review -> closeout explanation, live-evidence gate |
