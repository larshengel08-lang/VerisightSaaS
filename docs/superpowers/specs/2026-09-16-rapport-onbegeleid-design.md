...
- **Hoofdreden-cel op p.02 (taak 4):** de noemer volgt dezelfde regel als blok 2: het aantal vertrekkers dat een reden gaf als dat kleiner is dan het aantal ingevulde vragenlijsten ("van de 10 vertrekkers die een reden gaven"), anders "van de 12 vertrekkers". Gelijkspel en "vaker" komen uit `exit_r_top` (volledige teller), niet uit de top 5 van de tabel; bij "vaker" staan alle redenen met de hoogste telling.
