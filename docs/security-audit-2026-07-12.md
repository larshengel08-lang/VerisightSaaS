...
**Status fixes (gemerged naar `main` via PR #186 op 2026-07-13, gedeployed; migratie `2026_07_13_lock_individual_data_to_operator.sql` LIVE toegepast in Supabase → H1/H2 afgedwongen op de datalaag):**
