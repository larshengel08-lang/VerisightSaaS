...
- Suite-capable contracts en loader seams blijven behouden

## Closeout Gate
- Overzichtsscherm leest als afdelingssuite
- Inline create/edit is weg van het hoofdscherm
- Dossiers zijn read-first en review loopt via dossiercontext
- MTO-only activatie en suite-capable seams blijven aantoonbaar intact
