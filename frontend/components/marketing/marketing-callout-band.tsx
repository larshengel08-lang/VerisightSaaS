...
export function MarketingCalloutBand({
  ...
  return (
    <div className={`marketing-panel-soft p-7 md:p-9 ${className}`.trim()}>
      ...
      <div className="marketing-hero-cta-row mt-6">
        <Link
          href={primaryHref}
          className="inline-flex items-center justify-center rounded-full bg-blue-600 px-5 py-3 text-sm font-semibold text-white shadow-[0_16px_40px_rgba(37,99,235,0.18)] transition-all hover:-translate-y-0.5 hover:bg-blue-700"
        >
          {primaryLabel}
        </Link>
