...
const scans = [
  {
    ...
    output: 'Rapport met waarom mensen weggingen, volgens henzelf, en wat je als eerste aanpakt.',
  ...
  },
  {
    ...
    output: 'Rapport met waar het wringt, wat je mensen erover zeggen, en waar je begint. Per afdeling, nooit per persoon.',
