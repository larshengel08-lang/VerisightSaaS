        ...
        <div className="grid grid-cols-1 items-start gap-10 lg:grid-cols-[1fr_360px] lg:gap-16">
          <div>
            ...
            <div style={{ animation: 'slideUpFade .8s cubic-bezier(.16,1,.3,1) .3s both' }}>
              ...
              >
                Verisight laat publiek zien hoe privacy, rapportage en wat u wel en niet terugziet zijn ingericht,
                zodat u de basis kunt toetsen voordat een traject start.
              </p>
            </div>
          </div>
