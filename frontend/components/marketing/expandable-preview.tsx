    ...
    <>
      <div className={className}>
        <button
          ...
          className="group relative block w-full overflow-hidden rounded-2xl border border-[#E5E0D6] bg-white text-left transition hover:border-[#C96A4B] hover:shadow-md"
        >
          {badge && (
          ...
          <div className="flex items-center justify-between border-t border-slate-200 px-4 py-3">
            ...
            <span className="text-sm font-semibold text-[#C96A4B]">Open preview</span>
          </div>
        </button>
      </div>
