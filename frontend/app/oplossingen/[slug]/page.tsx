  ...
  if (solutionPage) {
    return {
      ...
      openGraph: {
        ...
        title: solutionPage.seoTitle,
        description: solutionPage.description,
        url: `https://www.getloep.nl${solutionPage.canonical}`,
      ...
      '@graph': [
        {
          ...
          url: `https://www.getloep.nl${solutionPage.canonical}`,
          inLanguage: 'nl-NL',
          isPartOf: { '@type': 'WebSite', name: 'Loep', url: 'https://www.getloep.nl' },
          about: { '@type': 'Service', name: solutionPage.productLabel, url: `https://www.getloep.nl${solutionPage.productHref}` },
        },
        {
          '@type': 'BreadcrumbList',
          itemListElement: [
            { '@type': 'ListItem', position: 1, name: 'Home', item: 'https://www.getloep.nl/' },
            { '@type': 'ListItem', position: 2, name: 'Oplossingen', item: 'https://www.getloep.nl/producten' },
            { '@type': 'ListItem', position: 3, name: solutionPage.title, item: `https://www.getloep.nl${solutionPage.canonical}` },
          ],
        },
      ],
    }
