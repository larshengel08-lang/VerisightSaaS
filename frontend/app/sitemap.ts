...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    { url: 'https://www.getloep.nl', lastModified: new Date('2026-07-04'), changeFrequency: 'monthly', priority: 1 },
    { url: 'https://www.getloep.nl/producten', lastModified: new Date('2026-07-04'), changeFrequency: 'monthly', priority: 0.9 },
    { url: 'https://www.getloep.nl/kennismaking', lastModified: new Date('2026-07-04'), changeFrequency: 'monthly', priority: 0.8 },
