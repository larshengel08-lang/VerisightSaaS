        ...
        heroIntro={
          <MarketingHeroIntro>
            ...
            <h1 className="marketing-hero-title marketing-hero-title-page font-display text-slate-950">
              Twee live routes en een bewuste combinatie.
            </h1>
            <p className="marketing-hero-copy text-slate-600">
              ...
              waar behoud schuift, of beide vragen pas daarna bewust naast elkaar willen organiseren.
            </p>
        ...
        heroStage={
          <MarketingHeroStage>
            <div className="space-y-5">
              <span className="marketing-stage-tag bg-blue-400/12 text-blue-100">Chooser-first</span>
        ...
        heroSupport={
          <MarketingHeroSupport>
            <div className="marketing-support-note text-sm leading-7 text-slate-600">
              ...
              doorsturen naar de detailpagina waar de deliverable en sample-output echt landen.
            </div>
