    ...
    <div className="min-h-screen bg-white font-sans">
      ...
      <section className="py-20 max-w-6xl mx-auto px-6">
        <div className="max-w-3xl mx-auto">
          <div className="bg-white border border-gray-200 rounded-2xl p-8 md:p-10 flex flex-col md:flex-row gap-8 items-center md:items-start">
            <div className="flex-shrink-0">
              <img
                src="https://i.pravatar.cc/160?img=11"
                alt="Portret van de oprichter van Verisight"
                className="w-28 h-28 rounded-2xl object-cover shadow-sm"
              />
            </div>
            <div>
              <p className="text-xs font-semibold text-blue-600 uppercase tracking-wide mb-2">Wie staat hierachter</p>
              <h2 className="text-xl font-bold text-gray-900 mb-3">Lars van den Hengel</h2>
              <p className="text-gray-600 text-sm leading-relaxed mb-4">
                Verisight is gebouwd vanuit de overtuiging dat HR-teams betere beslissingen nemen
                als ze beschikken over gestructureerde data. Te veel organisaties missen grip op
                vertrekredenen — niet door gebrek aan interesse, maar door gebrek aan de juiste tools
                en methodiek. Verisight brengt daar verandering in.
              </p>
              <a
                href="https://www.linkedin.com/in/larsvandenhengel"
                target="_blank"
