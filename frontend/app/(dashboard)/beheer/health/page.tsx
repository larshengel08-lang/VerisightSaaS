  ...
  return (
    <div className="space-y-6">
      ...
      <DashboardSection
        ...
        description="Deze bounded supportlaag is pas relevant wanneer je een handoff-, review- of closeoutflow wilt nalopen."
      >
        <DashboardDisclosure
          surface="ops"
          title="Open Action Center ops-read"
          description="Gebruik deze laag alleen wanneer je wilt terugzoeken of handoff, review en closeout echt in telemetry zichtbaar zijn."
          badge={<DashboardChip surface="ops" label={`${actionCenterOps.coveredEventTypes.length} flowtypes zichtbaar`} tone="slate" />}
        >
      ...
      <DashboardSection
        ...
        description="Gebruik deze supportlaag alleen voor onboarding-light en go / no-go. Hij hoeft niet standaard open te staan op de healthroute."
      >
        <DashboardDisclosure
          surface="ops"
          title="Open pilotdocs en readiness"
          description="Deze laag ondersteunt support en onboarding, maar hoort niet op hetzelfde gewicht te staan als de healthkern hierboven."
          badge={<DashboardChip surface="ops" label="Supportlaag" tone="slate" />}
        >
          <div className="space-y-4">
            <div className="grid gap-4 lg:grid-cols-3">
              <DashboardPanel
            ...
            <div className="grid gap-4 lg:grid-cols-2">
              <div className="rounded-[2rem] border border-slate-200 bg-white p-6">
                ...
                <ul className="mt-4 space-y-2 text-sm text-slate-700">
                  ...
                  <li>HR kan closeout, vervolg en lineage daarna nog teruglezen.</li>
                </ul>
              </div>
              <div className="rounded-[2rem] border border-slate-200 bg-white p-6">
      ...
      <DashboardSection
        ...
        description="Gebruik de volledige eventtabel alleen wanneer je een concrete flow of supportvraag moet terugzoeken."
      >
        <DashboardDisclosure
          surface="ops"
          title="Open recente telemetry"
          description="De laatste bounded telemetryevents uit de live suite. Dit vervangt de oude sampletelling."
          badge={<DashboardChip surface="ops" label={`${rows.length} events`} tone="slate" />}
        >
