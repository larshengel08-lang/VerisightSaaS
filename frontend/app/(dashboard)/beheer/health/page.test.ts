...
describe('beheer health page', () => {
  it('renders the health page as a transition registry', async () => {
    ...
    expect(html).toContain('Pilot operationalisering')
    expect(html).toContain('docs/ops/ACTION_CENTER_PILOT_PLAYBOOK.md')
    expect(html).toContain('docs/ops/ACTION_CENTER_PILOT_READINESS_CHECKLIST.md')
