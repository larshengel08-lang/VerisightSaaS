...
type CreateLearningDossierBody = {
  ...
  title?: string
  route_interest?: 'exitscan' | 'retentiescan' | 'culture_assessment' | 'teamscan' | 'combinatie' | 'nog-onzeker'
...
export async function POST(request: Request) {
  ...
  if (!['exitscan', 'retentiescan', 'culture_assessment', 'teamscan', 'combinatie', 'nog-onzeker'].includes(routeInterest)) {
