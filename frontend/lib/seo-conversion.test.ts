...
describe('SEO conversion tranche', () => {
  ...
  it('keeps llms.txt aligned with the current pricing and product routes', () => {
    ...
    expect(llmsText).toContain('https://www.getloep.nl/producten/cultuurbeeld')
    expect(llmsText).toContain('https://www.getloep.nl/producten/pulse')
    expect(llmsText).toContain('https://www.getloep.nl/producten#loep-start')
    expect(llmsText).toContain('https://www.getloep.nl/producten/leadership-scan')
    expect(llmsText).not.toContain('TeamScan')
    expect(llmsText).not.toContain('https://www.getloep.nl/producten/teamscan')
  })
})
