...
describe('SEO conversion tranche', () => {
  ...
  it('adds solution routes to the sitemap and excludes example pdfs', () => {
    ...
    expect(urls).toContain('https://www.verisight.nl/producten/cultuurbeeld')
  ...
  it('keeps llms.txt aligned with the current pricing and product routes', () => {
    ...
    expect(llmsText).toContain('https://www.verisight.nl/producten#loep-vertrek')
    expect(llmsText).toContain('https://www.verisight.nl/producten#loep-behoud')
    expect(llmsText).toContain('https://www.verisight.nl/producten/cultuurbeeld')
    expect(llmsText).toContain('https://www.verisight.nl/producten/pulse')
    expect(llmsText).toContain('https://www.verisight.nl/producten#loep-start')
