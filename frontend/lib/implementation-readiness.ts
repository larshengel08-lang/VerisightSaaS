...
export function getDeliveryModeDescription(mode: DeliveryMode | null | undefined, scanType: ScanType) {
  ...
  if (resolved === 'live') {
    return scanType === 'retention'
      ? 'Gebruik dit pas nadat een eerste Loep Behoud-baseline en opvolgritme staan. Live of ritme is een vervolgroute, geen standaard eerste setup.'
      : scanType === 'team'
        ...
        : scanType === 'onboarding'
          ...
          : 'Gebruik dit pas nadat Loep Vertrek Baseline, volumelogica en eigenaar voor opvolging scherp zijn. Live blijft een bewuste vervolgroute.'
  }

  return scanType === 'retention'
    ? 'Dit is de standaard eerste route voor Loep Behoud. Gebruik baseline om eerst een privacy-first groepsbeeld en eerste managementduiding op te bouwen.'
    : scanType === 'team'
      ...
      : scanType === 'onboarding'
        ...
        : 'Dit is de standaard eerste route voor Loep Vertrek. Gebruik baseline om vertrek eerst bestuurlijk leesbaar te maken voordat doorlopende opvolging logisch wordt.'
}
