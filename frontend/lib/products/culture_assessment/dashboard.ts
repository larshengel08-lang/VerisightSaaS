  ...
  return {
    ...
    followThroughCards: [
      ...
      },
      {
        ...
        body: 'Kies pas na de board-read tussen geen onmiddellijke vervolgrichting, deeper governed work, een bounded Pulse-follow-on of een andere Loep-route zoals Loep Behoud of Loep Vertrek als de vervolgvraag echt smaller is.',
        tone: 'emerald',
      },
    ],
    managementBandOverride: null,
