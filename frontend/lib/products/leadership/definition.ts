...
export const leadershipScanDefinition: ScanDefinition = {
  ...
  howToReadText:
    'Lees Leadership Scan als begrensde managementread: welke factor kleurt het beeld het sterkst, welke managementcontext vraagt nu eerst duiding, wie moet het eerste gesprek trekken en welke kleine verificatie of correctie hoort daar logisch bij. Gebruik dit als geaggregeerde management-context triage, niet als named leader read.',
  privacyBoundaryText:
  ...
  evidenceStatusText:
    'Leadership Scan is in deze eerste waves methodisch smal: campaign-centered, privacy-first en expliciet zonder identity- of hierarchylaag. De huidige vorm helpt managementcontext duiden en een eerste managementhandoff maken, maar is nog geen named leader model, 360-laag of bewijs van individuele leiderschapskwaliteit.',
  signalHelp:
