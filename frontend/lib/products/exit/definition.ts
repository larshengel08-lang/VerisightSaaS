...
export const exitScanDefinition: ScanDefinition = {
  scanType: 'exit',
  productName: 'Loep Vertrek',
  signalLabel: 'Frictiescore',
  signalLabelLower: 'frictiescore',
  summaryLabel: 'Sterk frictiesignaal',
  methodologyText:
    'Loep Vertrek maakt vertrekduiding bestuurlijk leesbaar. Het product bundelt vertrekredenen, meespelende factoren, eerdere signalering en signalen van werkfrictie tot een indicatief managementbeeld dat helpt prioriteren en doorvragen, zonder oorzaken definitief vast te stellen.',
  whatItIsText:
  ...
  segmentText:
    'Als segment deep dive aanstaat, laat Loep Vertrek zien welke subgroepen relatief afwijken van het organisatieniveau. Dat helpt bepalen waar vervolgvragen het meeste opleveren, zonder segmentverschillen als causale verklaring te lezen.',
}
