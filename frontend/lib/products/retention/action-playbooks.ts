...
export const RETENTION_ACTION_PLAYBOOK_CALIBRATION_NOTE =
  'Deze playbooks zijn v1-richtlijnen op basis van werkfactoren en signaalpatronen. We ijken ze na de eerste pilotronde op echte Loep Behoud-data, zodat prioritering en actieroutes beter aansluiten op wat in de praktijk het meeste effect heeft.'
