...
export const onboardingScanDefinition: ScanDefinition = {
  ...
  howToReadText:
    'Lees onboarding als vroege managementhandoff van een enkel checkpoint: welke succesvoorwaarden zijn zichtbaar, welke frictie valt nu op, wie trekt de eerste stap en welke beperkte borg- of correctieactie hoort daar direct bij.',
  privacyBoundaryText:
