...
export const onboardingScanDefinition: ScanDefinition = {
  ...
  whatItIsNotText:
    'Geen client onboarding-check, geen individuele score, geen performance-instrument, geen later uitkomstmodel en geen volledige employee-journey analyse.',
  howToReadText:
  ...
  reliabilityText:
    'Grafieken en patroonanalyse tonen we pas vanaf minimaal 10 responses. Deze onboardingvorm lees je als groepsread en assisted checkpoint-handoff voor een enkel meetmoment, niet als multi-checkpoint journey of individuele voorspelling.',
  segmentText:
