...
export const FOLLOW_ON_MARKETING_PRODUCTS: MarketingProduct[] = [
  {
    ...
    label: 'Pulse',
    shortLabel: 'Pulse',
    tagline: 'Compacte herijking na een eerdere managementread',
    description:
      'Bounded vervolgroute als compacte reviewroute nadat een eerdere managementread of eerste actie al staat. Bedoeld voor gerichte herijking en bounded hercheck, niet als derde brede instap.',
    seoTitle: 'Pulse | Compacte herijking na een eerdere managementread',
    ogAlt: 'Pulse productpagina van Verisight',
    serviceType: 'Compacte herijking na een eerdere managementread',
    serviceAudience: 'HR-teams en directies die na een eerste scan gericht willen blijven volgen',
    serviceOutput:
      'Compacte managementhandoff, bounded hercheck, begrensde vergelijkingsduiding en expliciet reviewmoment',
    status: 'bounded_live',
