...
export const LIVE_MARKETING_PRODUCTS: MarketingProduct[] = [
  {
    ...
    description:
      'Vertrekduiding op basis van terugkerende werkfactoren, vertrekredenen en werksignalen voor HR, MT en directie.',
    ...
    serviceOutput: 'Managementsamenvatting, vertrekduiding, werksignalen en prioritaire werkfactoren',
    status: 'live',
  ...
  },
  {
    ...
    description:
      'Vroegsignalering op behoud op groeps- en segmentniveau, op basis van werkbeleving, stay-intent, vertrekintentie en beinvloedbare werkfactoren.',
    ...
    serviceOutput: 'Managementsamenvatting, retentiesignaal, stay-intent, vertrekintentie, bevlogenheid en topfactoren voor verificatie en opvolging',
    status: 'live',
