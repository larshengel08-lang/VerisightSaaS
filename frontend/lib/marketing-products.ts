...
export const LIVE_MARKETING_PRODUCTS: MarketingProduct[] = [
  {
    ...
    description:
      'Vertrekduiding op basis van terugkerende werkfactoren, vertrekredenen en werksignalen voor HR, MT en directie, met compacte bestuurlijke handoff en expliciete leeswijzers over claims, privacy en interpretatie.',
    ...
    serviceOutput: 'Managementsamenvatting, bestuurlijke handoff, vertrekduiding, werksignalen, prioritaire werkfactoren en interpretatiekaders',
    status: 'live',
  ...
  },
  {
    ...
    description:
      'Vroegsignalering op behoud op groeps- en segmentniveau, op basis van werkbeleving, stay-intent, vertrekintentie en beinvloedbare werkfactoren, met compacte bestuurlijke handoff en zonder individuele voorspelling.',
    ...
    serviceOutput: 'Managementsamenvatting, bestuurlijke handoff, retentiesignaal, stay-intent, vertrekintentie, bevlogenheid, topfactoren en groepsgerichte leeswijzers voor verificatie en opvolging',
    status: 'live',
