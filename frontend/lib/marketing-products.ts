...
export const LIVE_MARKETING_PRODUCTS: MarketingProduct[] = [
  {
    ...
    description:
      'Vertrekduiding op basis van terugkerende werkfactoren, vertrekredenen en werksignalen voor HR, MT en directie, met expliciete leeswijzers over claims, privacy en interpretatie.',
    ...
    serviceOutput: 'Managementsamenvatting, vertrekduiding, werksignalen, prioritaire werkfactoren en interpretatiekaders',
    status: 'live',
  ...
  },
  {
    ...
    description:
      'Vroegsignalering op behoud op groeps- en segmentniveau, op basis van werkbeleving, stay-intent, vertrekintentie en beinvloedbare werkfactoren, zonder individuele voorspelling.',
    ...
    serviceOutput: 'Managementsamenvatting, retentiesignaal, stay-intent, vertrekintentie, bevlogenheid, topfactoren en groepsgerichte leeswijzers voor verificatie en opvolging',
    status: 'live',
