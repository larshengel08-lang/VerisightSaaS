...
describe('follow-on route content', () => {
  ...
  it('uses the revised spreadsheet copy for onboarding, leadership, pulse and combinatie overview content', () => {
    expect(FOLLOW_ON_ROUTE_CONTENT.map((route) => route.rowSummary)).toEqual([
      'Als vroege landing of eerste uitval extra aandacht vraagt.',
