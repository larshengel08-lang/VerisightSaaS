...
def test_responsbasis_shows_counts_and_segment_reason():
    html = _responsbasis(invited=45, completed=34, period="apr–mei 2026",
...
def test_managementspoor_eigenaarschap_is_blank_not_ai_suggested():
    """Plan 3b: het invulblok is verhuisd naar de besluitpagina; de agenda
    suggereert nog steeds geen eigenaar.
    """
    html = _eerste_managementspoor(
        primary_theme="Groeiperspectief + vertrekcontext", second_point="Beloning",
        mgmt_q="Welke loopbaanstappen ontbreken?",
