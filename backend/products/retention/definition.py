...
SCAN_DEFINITION: dict[str, Any] = {
    ...
    "survey_intro": "Jouw mening telt. Deze RetentieScan kijkt naar groepssignalen over werkbeleving en behoud - niet naar individuele beoordeling of voorspelling. Invullen kost circa 6 minuten.",
    ...
    "dashboard_signal_help": "Retentiesignaal 1-10: een gelijkgewogen v1-samenvatting van SDT-werkbeleving en beinvloedbare werkfactoren. Hogere score = sterker groepssignaal dat behoud aandacht vraagt.",
