...
SCAN_DEFINITION: dict[str, Any] = {
    ...
    "survey_intro": "Jouw mening telt. Vul deze scan vertrouwelijk in - het kost circa 6 minuten.",
    "survey_privacy_note": "Je antwoorden worden vertrouwelijk verwerkt en alleen op groeps- of segmentniveau gerapporteerd. De uitkomsten zijn bedoeld als managementinformatie over werkbeleving en behoud, niet als individueel oordeel of voorspelling. Als je tussentijds stopt, bewaart deze browser tijdelijk een concept op dit apparaat totdat je verzendt of het concept wist.",
    ...
    "open_text_label": "Wat zou jouw werkbeleving of bereidheid om te blijven het meest verbeteren?",
    "open_text_placeholder": "Welke verandering zou jouw werkbeleving of bereidheid om te blijven het sterkst verbeteren?",
    "open_text_help": "Je antwoord wordt geanonimiseerd opgeslagen en alleen als groepssignaal gebruikt.",
    "invite_intro": "Je leidinggevende of HR-afdeling nodigt je uit om een korte vragenlijst in te vullen over jouw werkbeleving en retentiesignalen. Jouw input wordt vertrouwelijk verwerkt en helpt de organisatie eerder bij te sturen.",
    "invite_duration": "6-10 minuten",
    "contact_subject": "Kennismakingsaanvraag RetentieScan",
    "dashboard_signal_help": "Retentieschaal 1-10: een gelijkgewogen samenvatting van SDT en beinvloedbare werkfactoren. Hogere score = sterker vroegsignaal dat behoud aandacht vraagt in de groep.",
