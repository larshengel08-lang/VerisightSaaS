...
WORK_QUESTIONS: dict[str, dict[str, dict[str, str]]] = {
    "leadership": {
        "ldd_feedback": {
            ...
            "exit": "Een medewerker levert nu werk in dat beter kan. Van wie hoort die wat er anders moet, en hoe snel? En in de periode waarin deze mensen vertrokken?",
        },
        "ldd_mandate": {
        ...
        "ldd_escalation": {
            ...
            "exit": "Als een medewerker nu vastloopt in een situatie of een spanning: wat doet de leidinggevende dan, en binnen hoeveel dagen? En in de periode waarin deze mensen vertrokken?",
        },
        "ldd_recognition": {
        ...
        "ldd_availability": {
            ...
            "exit": "Hoe snel krijgt een medewerker nu antwoord van de leidinggevende, en weet die vooraf wat die mag verwachten? En in de periode waarin deze mensen vertrokken?",
        },
        "ldd_consistency": {
    ...
    "culture": {
        "cud_safety": {
            ...
            "exit": "Een medewerker meldt nu zelf een fout. Wie reageert, en wat zien collega's daarvan? En in de periode waarin deze mensen vertrokken?",
        },
        "cud_dissent": {
        ...
        "cud_conflict": {
            ...
            "exit": "Twee collega's komen er nu samen niet uit. Wie begint erover, hoe snel, en wie helpt? En in de periode waarin deze mensen vertrokken?",
        },
        "cud_agreements": {
        ...
        "cud_crossteam": {
            ...
            "exit": "Twee teams hangen nu van elkaars werk af. Wat spreken ze met elkaar af, en wie beslist als het botst? En in de periode waarin deze mensen vertrokken?",
        },
    },
    "growth": {
        "grd_visibility": {
        ...
        "grd_criteria": {
            ...
            "exit": "Wat moet een medewerker nu laten zien om door te groeien, en waar kan die dat nalezen? Stond dat er al in de periode waarin deze mensen vertrokken?",
        },
        "grd_nextstep": {
    ...
    "workload": {
        "wld_scope": {
            ...
            "exit": "Er komt nu werk bij voor een team dat al vol zit. Wie zegt wat er dan afgaat? En in de periode waarin deze mensen vertrokken?",
        },
        "wld_planning": {
        ...
        "wld_peaks": {
            ...
            "exit": "Welke pieken zien jullie nu aankomen, en wie mag zeggen: dit kan er niet bij? Wie mocht dat zeggen in de periode waarin deze mensen vertrokken?",
        },
        "wld_recovery": {
            ...
            "exit": "Na een drukke periode: wat mag er nu blijven liggen, en hoe weet het team dat het mag? En in de periode waarin deze mensen vertrokken?",
        },
        "wld_priorities": {
        ...
        "wld_friction": {
            ...
            "exit": "Welk dubbel werk of systeemgedoe kost nu de meeste tijd, en wie lost het eerste punt op? Wat ervan bestond al in de periode waarin deze mensen vertrokken?",
        },
    },
    "role_clarity": {
        "rcd_priorities": {
        ...
        "rcd_expectations": {
            ...
            "exit": "Waarop wordt een medewerker nu aangesproken, en wist die dat vooraf? Waar staan die verwachtingen? Stonden ze er al in de periode waarin deze mensen vertrokken?",
        },
        "rcd_alignment": {
            ...
            "exit": "Een medewerker krijgt nu van twee kanten iets anders te horen. Wie hakt de knoop door, en hoe snel? En in de periode waarin deze mensen vertrokken?",
        },
        "rcd_scope": {
        ...
        "rcd_information": {
            ...
            "exit": "Iemand neemt nu een klus of dienst over. Wat moet die weten, en wie zorgt dat het er ligt? En in de periode waarin deze mensen vertrokken?",
        },
    },
}
