...
SCAN_DEFINITION: dict[str, Any] = {
    ...
    "trust_contract": {
        "what_it_is": (
            "Een korte follow-up scan voor actuele werkbeleving op groepsniveau. Pulse helpt zien of "
            "eerder gekozen acties, prioriteiten of spanningen op dit meetmoment nog aandacht vragen."
        ),
        "what_it_is_not": (
            "Geen brede MTO, geen vervanging van RetentieScan, geen trendbewijs op zichzelf en geen "
            "individuele beoordeling of voorspeller."
        ),
        "how_to_read": (
            "Lees Pulse als momentopname: welke werkfactoren en basisbehoeften staan nu het meest onder druk, "
            "welke managementvraag hoort daar direct bij en wat moet je eerst reviewen of bijsturen."
        ),
        "privacy_boundary": (
    ...
    "survey_intro": (
        ...
        "groepssignaal voor review op dit meetmoment en niet als individuele beoordeling. Invullen kost circa 3 minuten."
    ),
    "survey_privacy_note": (
    ...
    "sdt_intro": (
        "Deze drie stellingen geven een korte momentopname van je werkbeleving. Geef aan in welke mate elke stelling "
    ...
    "stay_intro": (
        "Deze vraag helpt om de huidige momentopname te lezen als reviewsignaal: blijft jouw werkcontext nu in de goede richting bewegen?"
    ),
    ...
    "dashboard_signal_help": (
        "Pulsesignaal 1-10: samenvattende momentopname van korte SDT-check-ins en de geselecteerde werkfactoren in deze cycle. "
    ...
    "report_repeat_body": (
        "Deze eerste Pulse-wave levert alleen een actuele snapshot. Vergelijking met een vorige Pulse-cycle en echte deltalezing "
        "horen pas in de volgende wave."
    ),
    "sdt_items": [
