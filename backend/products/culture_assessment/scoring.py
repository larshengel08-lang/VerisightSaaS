...
BOARD_ATTENTION_LOGIC: dict[str, Any] = {
    "mode": "domain_score_based_v1_attention_logic",
    "implemented_inputs": [
        "domain_scores",
        "recurring_theme_pairs",
    ],
    "planned_governed_inputs": [
        "segment_spread",
        "response_coverage",
        "contrast_strength",
    ...
    "priority_reasons": [
        ...
        "bestuurlijke verificatie op basis van het domeinbeeld",
    ],
    ...
    *,
    ...
    for index, (domain_id, score) in enumerate(lowest_domains, start=1):
        if score <= 5.2:
            ...
            priority_reason = "bestuurlijke verificatie op basis van het domeinbeeld"
